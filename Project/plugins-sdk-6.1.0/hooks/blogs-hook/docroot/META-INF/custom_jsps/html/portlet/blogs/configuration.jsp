	...
	<c:choose>
		...
		<c:when test='<%= tabs2.equals("display-settings") %>'>
			...
			<aui:fieldset>
				...
				<aui:select label="Display Query" name="preferences--pageDisplayQuery--">
					<aui:option label="None" selected="none" />
					<aui:option label="Most Commented" selected="most-commented" />
					<aui:option label="Most Popular" selected="most-popular" />
